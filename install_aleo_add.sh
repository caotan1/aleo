...
TARGET_DIR="/home/ubuntu/zk_work"
...
echo 'nohup ./zk_work_aleo --pool aleo.hk.zk.work:10003 --address ALEO_ADDRESS --custom_name CUSTOM_NAME >> zk_work.log 2>&1 &' > $TARGET_DIR/$START_FILE 
...
[Service]  
Type=simple  
ExecStart=/home/ubuntu/zk_work/watch_aleo
Restart=on-failure  
RestartSec=10s 
